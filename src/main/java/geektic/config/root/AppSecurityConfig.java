...
import geektic.app.security.AjaxAuthenticationSuccessHandler;
import geektic.app.security.SecurityUserDetailsService;
...
public class AppSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .and()
            .formLogin()
            .defaultSuccessUrl("/resources/geektic.html")
