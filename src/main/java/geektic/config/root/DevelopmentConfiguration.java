package geektic.config.root;


import geektic.app.init.TestDataInitializer;
...
public class DevelopmentConfiguration {
    ...
    public DriverManagerDataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:postgresql://localhost:5432/geektic?loglevel=0");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DriverManagerDataSource dataSource) {
        ...
        entityManagerFactoryBean.setPackagesToScan(new String[]{"geektic.app.model"});
